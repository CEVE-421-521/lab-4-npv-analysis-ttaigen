...
A disadvantage of this framing is that we make some unrealistic assumptions, like that if there is a flood it will automatically be restored to the same condition as before.
...
Essentially, we have a piecewise linear function that depends on the area of the house and how high we elevate.
